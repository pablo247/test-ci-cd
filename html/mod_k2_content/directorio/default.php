...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
    ...
    <ul class="level0" uk-accordion="multiple: true">
		...
		<li>
			...
			<a class="uk-accordion-title fs-18 uk-accordion-data__title c-3c4145 uk-accordion-title" href="#"><?php echo $item->title; ?></a>
            <?php endif; ?>
