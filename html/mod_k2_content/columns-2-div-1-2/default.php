...
$classes = [
	(object)[
		"classPanelWidth" => "uk-width-1-3@m uk-width-1-1",
		"classPanel" => "bc-rojo-2 b-solid-1",
		"classTitle" => "c-c19e74",
	],
	(object)[
		"classPanelWidth" => "uk-width-2-3@m uk-width-1-1",
		"classPanel" => "bgc-brown-1",
		"classTitle" => "c-negro-1",
	],
];
?>
...
<div id="k2ModuleBox<?php echo $module->id; ?>"
    ...
    <div uk-grid uk-height-match="target: > div > div">
		...
		<?php $index=$key%2; ?>
        <div class="<?=$classes[$index]->classPanelWidth?>">
		<div class="<?=$classes[$index]->classPanel?> uk-padding uk-text-center">
			...
			<?php if ($params->get('itemImage') && !empty($item->image)): ?>
				<img style="width: 70px;" src="<?php echo $item->image; ?>"
					alt="<?php echo K2HelperUtilities::cleanHtml($item->title); ?>" />
			<?php endif; ?>

            <?php
            if($params->get('itemTitle')): ?>
                <h3 class="uk-h4 <?=$classes[$index]->classTitle?>" tabindex="0"><?php echo $item->title; ?></h3>
            <?php endif; ?>
