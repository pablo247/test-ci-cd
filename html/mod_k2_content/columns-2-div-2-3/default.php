...
$class1="uk-width-3-5@m uk-width-1-1";
$class2="uk-width-2-5@m uk-width-1-1";
?>
...
<div id="k2ModuleBox<?php echo $module->id; ?>"
    ...
    <div uk-grid uk-height-match="target: > div > div">
        ...
        <div class="<?=$key%2?$class1:$class2?>">
		<div class="b-solid-1 bc-rojo-2 uk-padding uk-text-center">
            ...
            if($params->get('itemTitle')): ?>
                <h2 class="uk-h4 c-c19e74" tabindex="0"><?php echo $item->title; ?></h2>
            <?php endif; ?>
            ...
            <div class="moduleItemIntrotext">
                ...
                <a class="moduleItemImage" href="<?= $item->extra_fields[0]->value ?>"
